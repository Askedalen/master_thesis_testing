...
def yield_generator_test(song_list, batch_size = 8, max_steps=2000, num_notes=128, vocabulary=100):
    ...
    while True:
        for file in song_list:
            ...
            if melody_data is False:
                continue
                #melody_data = np.zeros((num_notes, chord_data.shape[0]))
